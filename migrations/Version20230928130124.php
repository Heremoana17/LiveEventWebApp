 ...
 */
final class Version20230928130124 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE background_image ADD CONSTRAINT FK_941A9678C4663E4 FOREIGN KEY (page_id) REFERENCES page (id)');
    }
