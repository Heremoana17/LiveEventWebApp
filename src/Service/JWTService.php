...
class JWTService
{
    ...
    public function generate(array $header, array $payload, string $secret, int $validity = 10800): string
    {
        ...
        //on netoie les valeurs encodées (retrait des +, /, =)
    ...
    //on verifie si le token a expiré grace au payload
    ...
    //on verifie la signature grace au header et payload
    public function check(string $token, string $secret)
    {
        //on recupère le payload et le header
